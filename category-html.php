...
// Выбираем новости с категорией "html" для текущей страницы
    ...
    if ($pages > 1) {
      ...
      for ($i = 1; $i <= $pages; $i++) {
          if ($i == $page) {
              ...
              echo "<a href='category-html.php?page=$i'>$i</a>";
          }
      }
      echo "</div>";
    }
    else{
      echo "Новости с категорией 'html' не найдены.";
    }
}
?>
</body>
