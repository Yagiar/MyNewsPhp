...
// Выбираем новости с категорией "css" для текущей страницы
    ...
    if ($pages > 1) {
      ...
      for ($i = 1; $i <= $pages; $i++) {
          if ($i == $page) {
              ...
              echo "<a href='category-css.php?page=$i'>$i</a>";
          }
      }
      echo "</div>";
    }
    else{
      echo "Новости с категорией 'css' не найдены.";
    }
}
?>
</body>
